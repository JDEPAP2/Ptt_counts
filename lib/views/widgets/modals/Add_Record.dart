...
class _AddRecordState extends State<AddRecord> with TickerProviderStateMixin{
                ...
                onTap: () async{
                  if(typeR==null || fecha == "" || value == "" || name == "" || name.replaceAll(" ", "").isEmpty){
                    ...
                    if(personId != null){
                      ...
                      Record newRecord = Record(id: ObjectId(), nameId: personId, name: name, type:!(typeR??false), value: double.parse(value), date: FormatDate.stringToDate(fecha), observation: obser);
                      print("-------${newRecord.observation}----------");
